...
const timeText = document.querySelector(".timer .timer_txt");
...
function showResult(){
    ...
    if (userScore > 3*que_count/4){ // if user scored more than 3
        //creating a new span tag and passing the user score number and total question number
        let scoreTag = '<span>Skor anda: <p>'+ Math.floor((userScore/questions.length)*100) +'/100</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > que_count/2){ // if user scored more than 1
        let scoreTag = '<span>Skor anda: <p>'+ Math.floor((userScore/questions.length)*100) +'/100</p></span>';
